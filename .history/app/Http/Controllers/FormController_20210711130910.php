        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($q_user)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = $btn.'<a href="{{route('form-one-list')}}"><div data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="view" class="btn btn-sm btn-icon btn-outline-info btn-circle mr-2"><i class="ki ki-bold-menu"></i></div></a> ';
