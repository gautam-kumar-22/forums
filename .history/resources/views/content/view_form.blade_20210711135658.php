            ...
            <div class="modal-body">
                <form id="formUser" name="formUser">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Nama"><br>
                        <input type="email" name="form_email" class="form-control" id="form_email" placeholder="form_email"><br>
                        <br>
