                    ...
                    <div class="table-responsive">
                        <table class="table" id="tableUser">
                            ...
                            <tr>
                                <td>{{$r_users->id}}</td>
                                <td>{{$r_users->title}}</td>
                                <td>{{$r_users->form_email}}</td>
                                <td>{{$r_users->submited_form}}</td>
                                <!-- <td>{{$r_users->status}}</td> -->
                                <td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Form Update</h5>
            ...
            <div class="modal-body">
                <form id="formUser" name="formUser">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Form Title"><br>
                        <input type="email" name="form_email" class="form-control" id="form_email" placeholder="Form Email"><br>
                        <br>
                        <!-- <input type="text" name="password" class="form-control" placeholder="password"><br> -->
                        <input type="hidden" name="form_id" id="user_id" value="">
                    </div>
                </form>
            </div>
...
<script>
    $('document').ready(function () {
        ...
        $('body').on('click', '.editUser', function () {
            ...
            $.get("{{route('forms.index')}}" + '/' + user_id + '/edit', function (data) {
