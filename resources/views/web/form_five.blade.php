          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              {{ csrf_field() }}
                  ...
                  <div class="iknow_checkbox">
                    ...
                    <div class="form-group">
                      <label class="form-label" id="gift_for_corporate_lbl" for="gift_for_corporate">Last name *</label>
                    ...
                    <div class="form-group">
                      <label class="form-label" id="preference_of_basket_lbl" for="preference_of_basket">Phone *</label>
                      <input type="text" class="form-control" id="preference_of_basket" name="preference_of_basket" placeholder="" value="{{old('preference_of_basket','')}}" tabindex="1">
                    </div>
                    <div class="form-group">
                      <label class="form-label" id="preference_of_basket_lbl" for="preference_of_basket">Subject *</label>
                      <input type="text" class="form-control" id="preference_of_basket" name="preference_of_basket" placeholder="" value="{{old('preference_of_basket','')}}" tabindex="1">
                    </div>
                    <div class="form-group">
                      <label class="form-label" id="preference_of_basket_lbl" for="preference_of_basket">Message</label>
