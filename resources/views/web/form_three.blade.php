    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <form id="contact-form" name="myForm" class="form" action="{{route('form.three.store')}}"
                    ...
                    <div class="iknow_checkbox">
                        ...
                        <div class="form-group">
                            <label class="form-label" id="pickup_delivery_date_level" for="pickup_delivery_date">First
                                name *</label>
                            <input type="text" class="form-control" id="pickup_delivery_date"
                                name="first_name" placeholder="First Name"
                                value="{{old('first_name','')}}" tabindex="1">
                                <ul>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="last_name" name="last_name"
                                placeholder="last_name" value="{{old('last_name','')}}" tabindex="1">
                                <ul>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bokerage" name="bokerage"
                                placeholder="Bokerage" value="{{old('bokerage','')}}" tabindex="1">
                                <ul>
                                @if($errors->has('bokerage'))
                                <li style="color: red">
                                    {{$errors->first('bokerage')}}
                                </li>
                                @endif
                            </ul>
                        </div>
                        <div class="form-group">
                            <label class="form-label" id="preference_of_basket_lbl" for="preference_of_basket">Emails
                                *</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label><input type="radio" name="pmi" {{(old('pmi') == 'Preferred – Closing Gift & Year 1 Anniversary Gift') ? 'checked' : ''}}
                                        value="Preferred – Closing Gift & Year 1 Anniversary Gift"> Preferred – Closing
                                    Gift & Year 1 Anniversary Gift </label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="pmi" {{(old('pmi') == 'Premium – Closing Gift & Year 1/3/5 Anniversary Gift') ? 'checked' : ''}}
                                        value="Premium – Closing Gift & Year 1/3/5 Anniversary Gift"> Premium – Closing
                                    Gift & Year 1/3/5 Anniversary Gift</label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="pmi" {{(old('pmi') == 'Platinum – Closing Gift & Anniversary Gift Every Year') ? 'checked' : ''}}
                                        value="Platinum – Closing Gift & Anniversary Gift Every Year"> Platinum –
                                    Closing Gift & Anniversary Gift Every Yearv</label>
                            </div>
